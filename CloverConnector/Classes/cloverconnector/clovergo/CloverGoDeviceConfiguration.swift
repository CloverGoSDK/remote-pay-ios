...
public class CloverGoDeviceConfiguration : NSObject, CloverDeviceConfiguration {
    ...
    public var deviceType : ReaderInfo.CardReaderType = .RP450
    ...
    public class Builder {
        ...
        var deviceType : ReaderInfo.CardReaderType = .RP450
        ...
        public func deviceType(deviceType:ReaderInfo.CardReaderType) -> Builder {
